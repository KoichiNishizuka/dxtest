		...
		while (!ini)
		{
			...
			for (int g = 0; g < remain; g++)
			{
				...
				case 0:
					...
					DrawFormatString(600,20, GetColor(255, 255, 255), "×5");
					ScreenFlip();
					break;
				...
				case 1:
					...
					DrawFormatString(600, 20, GetColor(255, 255, 255), "×4");
					ScreenFlip();
					break;

				case 2:
					
					DrawFormatString(600,20, GetColor(255, 255, 255), "×3");
					ScreenFlip();
					break;
				...
				case 3:
					...
					DrawFormatString(600, 20, GetColor(255, 255, 255), "×2");
					ScreenFlip();
					break;
				...
				case 4:
					...
					DrawFormatString(600, 20, GetColor(255, 255, 255), "×1");
					ScreenFlip(); 
					break;
				...
				case 5:
					...
					DrawFormatString(600, 20, GetColor(255, 255, 255), "×0");
					ScreenFlip();
					break;
